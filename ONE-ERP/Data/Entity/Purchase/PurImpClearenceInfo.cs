...
{
    public class PurImpClearenceInfo:NewBase
    {
        [Key]
        ...
        public DateTime? ActualBankClrDate { get; set; }
        public DateTime? ExpectedCustomClrDate { get; set; }
        public DateTime? ExpectedDocumentReceiveDate { get; set; }
