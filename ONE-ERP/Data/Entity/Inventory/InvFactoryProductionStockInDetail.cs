...
{
    public class InvFactoryProductionStockInDetail:NewBase
    {
        [Key]
        [DatabaseGenerated(DatabaseGeneratedOption.Identity)]
        public int stockDetailsId { get; set; }
        public int? factoryProductionStockInIdId { get; set; }
        public InvFactoryProductionStockIn factoryProductionStockInId { get; set; }
